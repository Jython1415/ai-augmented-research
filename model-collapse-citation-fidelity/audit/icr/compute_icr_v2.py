...
"""Compute Krippendorff's alpha for ICR v2 calibration (narrow scope)."""
...
CODER_FILES = [
    "/private/tmp/claude/relevance/icr_v2_coder1.json",
    "/private/tmp/claude/relevance/icr_v2_coder2.json",
    "/private/tmp/claude/relevance/icr_v2_coder3.json",
]
...
if alpha >= 0.800:
    ...
    print("BELOW THRESHOLD -- revise instructions before proceeding")

# Compare with v1
print("\n--- Comparison with v1 ---")
print("v1 alpha: 0.766 (acceptable)")
print(f"v2 alpha: {alpha:.4f}")
if alpha > 0.766:
    print("IMPROVED from v1")
elif alpha < 0.766:
    print("DECLINED from v1 -- investigate")
else:
    print("UNCHANGED")
